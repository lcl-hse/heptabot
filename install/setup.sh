...
echo "We strongly suggest following the https://github.com/lcl-hse/heptabot/blob/gpu-tpu/notebooks/Install.ipynb notebook to avoid any unexpected problems."
