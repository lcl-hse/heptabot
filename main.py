...
def handle_exception(e):
    ...
    if isinstance(e, InputOverflow):
        ...
        error_obj["str2"] = Markup('You can process your data in our <a href="https://colab.research.google.com/github/lcl-hse/heptabot/blob/cpu/notebooks/Run_tiny_model_on_Colab_CPU.ipynb">Colab notebook</a> instead. <a href="/download">Click here</a> to download your data.')
