...
<p align="center"> <img height="200" src="./assets/example_correction" alt="Screenshot of an example text corrected by heptabot"> </p>
<center><i>An example text corrected by `heptabot`</i></center>
