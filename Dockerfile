...
RUN wget -q https://storage.googleapis.com/ml-bucket-isikus/heptabot-models/err_type_classifier.cbm -P ./models
RUN wget -q https://storage.googleapis.com/ml-bucket-isikus/heptabot-models/distilbert_stsb_model.tar.gz -p ./models
RUN tar -xzvf ./models/distilbert_stsb_model.tar.gz
RUN wget -q https://storage.googleapis.com/ml-bucket-isikus/heptabot-models/t5_tiny_model.tar.gz -p ./models
RUN tar -xzvf ./models/t5_tiny_model.tar.gz
